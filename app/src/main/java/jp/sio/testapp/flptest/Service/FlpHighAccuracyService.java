...
public class FlpHighAccuracyService extends Service implements
    ...
    //設定値の格納用変数
    private final String locationType = "FlpHighAccuracy";
    ...
    public class FlpHighAccuracyService_Binder extends Binder {
        public FlpHighAccuracyService getService() {
            return FlpHighAccuracyService.this;
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startid) {
        ...
        */
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK, getString(R.string.locationFlpHighAccuracy));
        wakeLock.acquire();
    ...
    public void locationSuccess(final Location location) {
        ...
        if (runningCount == settingCount && settingCount != 0) {
            ...
            intervalTimerTask = new FlpHighAccuracyService.IntervalTimerTask();
    ...
    */
    ...
    protected void sendLocationBroadCast(Boolean fix, Location location, long locationStartTime, long locationStopTime) {
        L.d("sendLocation");
        Intent broadcastIntent = new Intent(getResources().getString(R.string.locationFlpHighAccuracy));
    ...
    public IBinder onBind(Intent intent) {
        return new FlpHighAccuracyService_Binder();
    }
