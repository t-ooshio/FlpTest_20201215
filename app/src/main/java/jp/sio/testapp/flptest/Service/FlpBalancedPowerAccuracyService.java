...
public class FlpBalancedPowerAccuracyService extends Service implements
    ...
    public class FlpBalancedPowerAccuracyService_Binder extends Binder {
        public FlpBalancedPowerAccuracyService getService() {
            return FlpBalancedPowerAccuracyService.this;
        }
    }
    ...
    public void locationSuccess(final Location location) {
        ...
        if (runningCount == settingCount && settingCount != 0) {
            ...
            intervalTimerTask = new FlpBalancedPowerAccuracyService.IntervalTimerTask();
    ...
    */
    ...
    public IBinder onBind(Intent intent) {
        return new FlpBalancedPowerAccuracyService_Binder();
    }
