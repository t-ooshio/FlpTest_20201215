...
public class FlpNoPowerService extends Service implements
    ...
    public class FlpNoPowerService_Binder extends Binder {
        public FlpNoPowerService getService() {
            return FlpNoPowerService.this;
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startid) {
        ...
        */
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK, getString(R.string.locationFlpNoPower));
        wakeLock.acquire();
    ...
    public void locationSuccess(final Location location) {
        ...
        if (runningCount == settingCount && settingCount != 0) {
            ...
            intervalTimerTask = new FlpNoPowerService.IntervalTimerTask();
    ...
    */
    ...
    protected void sendLocationBroadCast(Boolean fix, Location location, long locationStartTime, long locationStopTime) {
        L.d("sendLocation");
        Intent broadcastIntent = new Intent(getResources().getString(R.string.locationFlpNoPower));
    ...
    public IBinder onBind(Intent intent) {
        return new FlpNoPowerService_Binder();
    }
