...
public class FlpLowPowerService extends Service implements
    ...
    //設定値の格納用変数
    private final String locationType = "FlpLowPower";
    ...
    public class FlpLowPowerService_Binder extends Binder {
        public FlpLowPowerService getService() {
            return FlpLowPowerService.this;
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startid) {
        ...
        */
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK, getString(R.string.locationFlpLowPower));
        wakeLock.acquire();
    ...
    public void locationSuccess(final Location location) {
        ...
        if (runningCount == settingCount && settingCount != 0) {
            ...
            intervalTimerTask = new FlpLowPowerService.IntervalTimerTask();
    ...
    */
    ...
    protected void sendLocationBroadCast(Boolean fix, Location location, long locationStartTime, long locationStopTime) {
        L.d("sendLocation");
        Intent broadcastIntent = new Intent(getResources().getString(R.string.locationFlpLowPower));
    ...
    public IBinder onBind(Intent intent) {
        return new FlpLowPowerService_Binder();
    }
